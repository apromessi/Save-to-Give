from model import User, Donation, Challenge, DonationChallenge, Transaction, Organization, connect_to_db, db
...
def load_donations():
    ...
    for line in donations_file:
        line = line.strip().split(",")
        a_donation = Donation(org_id = line[1],
        						product_name = line[2],
        						description = line[3],
        						donation_amount = line[4])
